...
export default function FrontendDeveloperSection() {
  ...
  return (
    ...
    animate-[shine_4s_linear_infinite]"
        >
          I build modern, responsive and immersive web applications using Java,
          React and creative frontend technologies to create beautiful digital
        ...
        >
          {["Java", "React.js", "MERN Stack", "Three.js"].map((tech) => (
            <div
              key={tech}
              className="
